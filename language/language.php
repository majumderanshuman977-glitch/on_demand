<?php
	  ...
	  $client_lang['lottery_design'] = "Lottery Balls Design";
	  
	  $client_lang['delete_lottery_design'] = "Lottery Design Deleted!";
	  
	  $client_lang['lottery_design_name'] = "Design Name";
	  
	  $client_lang['ticket_design'] = "Ticket Design";
	  
	  $client_lang['add_lotterydesign'] = "New Lottery Ticket Design Added!";
	  
	  $client_lang['update_lotterydesign'] = "Lottery Ticket Design Updated!";
	  
	  $client_lang['error_limit_ball'] = "ERROR: You can set maximum of 8 Balls Limit (Regular + Jackpot Balls Combined).";
	  
	  $client_lang['lottery_balls_name'] = "Name of the Ticket Design";
	  $client_lang['lottery_balls_name_help'] = "This will be used to save this design and further use in lottery";
